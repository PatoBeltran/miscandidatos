...
var ExpandPreview = (function() {
	...
	Preview.prototype = {
      ...
      eldata = {
        ...
        filer : $itemEl.data( 'filter' ),
        color : $itemEl.data( 'color' ),
        bio : $itemEl.data( 'bio' ),
        proposals : $itemEl.data( 'proposals' )
      };

      var milestones = [];
      for(var ii = 0; ii < $itemEl.data('milestone-count'); ii++) {
        milestones.push({
          position : $itemEl.data('milestone-'+ ii + '-position'),
          proposals : $itemEl.data('milestone-'+ ii + '-proposals'),
          accomplished : $itemEl.data('milestone-'+ ii + '-accomplished')
        });
      }

      eldata['milestones'] = milestones;

      //@TODO - add info to space markdown
